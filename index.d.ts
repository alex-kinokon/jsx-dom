...
declare module "jsx-dom" {
  ...
  export function createElement<Result extends Element, Props>(
    factory: (
      props: Props & { children: JSX.Child[] }
    ) => Result | DocumentFragment | Result[],
    props?: Props & { ref?: (instance: Result) => void; children?: any },
    ...children: JSX.Child[]
  ): Result

  export const createFactory: {
    <Tag extends keyof TagMap>(tagName: Tag): (
      props?: any,
      ...children: JSX.Child[]
    ) => TagMap[Tag]

    (tagName: string): (props?: any, ...children: JSX.Child[]) => HTMLElement

    <Result extends Element, Props>(
      factory: (
        props: Props & { children: JSX.Child[] }
      ) => Result | DocumentFragment | Result[]
    ): (
